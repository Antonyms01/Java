...
//Parameterized constructor should check the length of the password passed if it is less than 5 or more that 9 , it should raise
//"InvalidLengthException" 
...
public class Authenticator {
	Authenticator(String pass) throws InvalidLengthException
	{
		...
		{
			throw new InvalidLengthException("Wrong Password");
		}
